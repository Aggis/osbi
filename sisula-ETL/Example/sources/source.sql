...
BEGIN TRY -- using Microsoft.SQLServer.Types version 13 (2016)
	...
	AUTHORIZATION dbo
	FROM 'C:\dev\osbi\sisula-ETL\code\Utilities2016.dll'
...
BEGIN TRY -- using Microsoft.SQLServer.Types version 12 (2014)
	CREATE ASSEMBLY etlUtilities
	AUTHORIZATION dbo
	FROM 'C:\dev\osbi\sisula-ETL\code\Utilities2014.dll'
	WITH PERMISSION_SET = SAFE;
...
BEGIN TRY -- using Microsoft.SQLServer.Types version 11 (2012)
	CREATE ASSEMBLY etlUtilities
	AUTHORIZATION dbo
	FROM 'C:\dev\osbi\sisula-ETL\code\Utilities2012.dll'
	WITH PERMISSION_SET = SAFE;
...
BEGIN TRY -- using Microsoft.SQLServer.Types version 10 (2008)
	CREATE ASSEMBLY etlUtilities
	AUTHORIZATION dbo
	FROM 'C:\dev\osbi\sisula-ETL\code\Utilities2008.dll'
	WITH PERMISSION_SET = SAFE;
...
--
-- Generated: Wed Mar 1 14:33:53 UTC+0100 2017 by Aggis
-- From: AGGIS-COMP in the Aggis-Comp domain
--------------------------------------------------------------------------
